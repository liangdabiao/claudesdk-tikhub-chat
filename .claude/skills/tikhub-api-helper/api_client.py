...
class TikHubAPIClient:
    ...
    DEFAULT_TOKEN = "vZdfXsQag0amkXarPbOZ8S3nAi8aA=="

    def __init__(self, api_token: str = None, base_url: str = None, use_china_domain: bool = True):
        """
        ...
        Args:
            ...
            use_china_domain: Use China domain (api.tikhub.dev, default True)
        """
